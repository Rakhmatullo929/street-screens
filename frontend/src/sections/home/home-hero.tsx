    ...
    >
      ...
      <m.div variants={varFade().in}>
        <Typography variant="body2" sx={{ textAlign: 'center' }}>
          Complete solution for managing digital billboards. Control content, schedule campaigns,
          track analytics, and maximize your advertising impact with real-time monitoring.
        </Typography>
      </m.div>
        ...
        <Stack spacing={3} direction={{ xs: 'column', sm: 'row' }} justifyContent="center">
          <m.div variants={varFade().in}>
            <Stack direction="row" alignItems="center" spacing={1}>
              ...
              <Typography variant="caption">Billboard Management</Typography>
            </Stack>
          </m.div>
          <m.div variants={varFade().in}>
            <Stack direction="row" alignItems="center" spacing={1}>
              <Iconify icon="solar:videocamera-record-bold-duotone" width={20} />
              <Typography variant="caption">Content Control</Typography>
            </Stack>
          </m.div>
          <m.div variants={varFade().in}>
            <Stack direction="row" alignItems="center" spacing={1}>
              <Iconify icon="solar:chart-2-bold-duotone" width={20} />
              <Typography variant="caption">Real-time Analytics</Typography>
            </Stack>
          </m.div>
          <m.div variants={varFade().in}>
            <Stack direction="row" alignItems="center" spacing={1}>
