        ...
        >
            ...
            <m.div variants={varFade().in}>
                <Typography variant="body2" sx={{textAlign: 'center'}}>
                    StreetScreen connects brands, agencies, and screen owners in one place.
                    Launch campaigns, manage creatives, and monitor every street screen in real time.
                </Typography>
            </m.div>
            ...
            <Stack spacing={3} sx={{textAlign: 'center', opacity: 0.48}}>
                <m.div variants={varFade().in}>
                    <Typography variant="overline">Key Features</Typography>
                </m.div>

                <Stack spacing={3} direction={{xs: 'column', sm: 'row'}} justifyContent="center">
                    <m.div variants={varFade().in}>
                        <Stack direction="row" alignItems="center" spacing={1}>
                            <Iconify icon="solar:display-bold-duotone" width={20}/>
                            <Typography variant="caption">Screen Network Control</Typography>
                        </Stack>
                    </m.div>
                    <m.div variants={varFade().in}>
                        <Stack direction="row" alignItems="center" spacing={1}>
                            <Iconify icon="solar:videocamera-record-bold-duotone" width={20}/>
                            <Typography variant="caption">Creative Management</Typography>
                        </Stack>
                    </m.div>
                    <m.div variants={varFade().in}>
                        <Stack direction="row" alignItems="center" spacing={1}>
                            <Iconify icon="solar:chart-2-bold-duotone" width={20}/>
                            <Typography variant="caption">Live Campaign Analytics</Typography>
                        </Stack>
                    </m.div>
                    <m.div variants={varFade().in}>
                        <Stack direction="row" alignItems="center" spacing={1}>
                            <Iconify icon="solar:map-point-bold-duotone" width={20}/>
                            <Typography variant="caption">City Map View</Typography>
                        </Stack>
                    </m.div>
                </Stack>
            </Stack>
