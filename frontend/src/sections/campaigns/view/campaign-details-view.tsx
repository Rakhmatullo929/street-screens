                        ...
                        >
                            <Stack spacing={2}>
                                ...
                                <Typography variant="h4" sx={{
                                    fontWeight: 700,
                                    color: '#00b8d9'
                                }}>{campaign.involve_count}</Typography>
                                <Stack direction="row" alignItems="center" spacing={0.5}>
                                    <Typography variant="body2" color="text.secondary" sx={{fontWeight: 500}}>
                                        CTR: -
                                    </Typography>
                                    ...
                                    >
                                        <Stack spacing={1.5}>
                                            ...
                                            >
                                                <Stack spacing={0.5}>
                                                    <Stack direction="row" alignItems="center" spacing={1}>
                                                        <Iconify icon="solar:map-bold" width={16}
                                                                 sx={{color: 'info.main'}}/>
                                                    ...
                                                    <Stack direction="row" alignItems="center" spacing={1} pl={3}>
                                                        <Iconify icon="solar:point-on-map-bold" width={14}
                                                                 sx={{color: 'info.dark'}}/>
                                        ...
                                        <Stack spacing={1.5}>
                                            ...
                                            <Stack direction="row" spacing={1} flexWrap="wrap">
                                                {campaign.interests.map((interest) => (
                                                    <Chip key={interest.id} label={interest.name} size="small"
                                        ...
                                        <Stack spacing={1.5}>
                                            ...
                                            <Stack direction="row" spacing={1} flexWrap="wrap">
                                                {campaign.venue_types.map((type) => (
                                                    <Chip key={type.id} label={type.name} size="small" variant="soft"
                                                          color="success"/>
                                                ))}
                                            </Stack>
                                        </Stack>
