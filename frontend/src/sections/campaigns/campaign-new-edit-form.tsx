...
import { DISPLAY_DURATION_OPTIONS, CONTENT_TYPE_OPTIONS, convertBackendScheduleToCalendar } from 'src/constants/dooh-data';
...
export default function CampaignNewEditForm({
  ...
  const { mutate: createCampaign, loading: createLoading } = useApiMutation<IAdsManager, any>({
    ...
    method: 'POST',
    onSuccess: () => {
      enqueueSnackbar('Кампания успешно создана!', { variant: 'success' });
      navigate(paths.dashboard.adsManager);
    },
    onError: (error) => {
      console.error('Error creating campaign:', error);
      enqueueSnackbar('Ошибка при создании кампании', { variant: 'error' });
    },
  });
  ...
  const { mutate: updateCampaign, loading: updateLoading } = useApiMutation<IAdsManager, any>({
    ...
    method: 'PUT',
    onSuccess: () => {
      enqueueSnackbar('Кампания успешно обновлена!', { variant: 'success' });
      navigate(paths.dashboard.adsManager);
    },
    onError: (error) => {
      console.error('Error updating campaign:', error);
      enqueueSnackbar('Ошибка при обновлении кампании', { variant: 'error' });
    },
  });
  ...
  const onSubmit = useCallback(
    async (data: FormValues) => {
      try {
        ...
        enqueueSnackbar('Ошибка при сохранении кампании', { variant: 'error' });
      }
    },
                  ...
                  <Card sx={{ p: 3 }}>
                    <Stack spacing={3}>
                      <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <Typography variant="h6">Период размещения</Typography>
                      </Stack>
                              ...
                              <Stack spacing={2}>
                                ...
                                <Stack direction="row" alignItems="center" spacing={2}>
                                  ...
                                  <Box sx={{ flex: 1 }}>
                                    ...
                                    <Typography variant="body2" color="success.dark">
                                      {currentCampaign.videos?.[0]?.title || 'Видео файл'}
                                  ...
                                  <Chip
                                    ...
                                    size="small"
                                    variant="soft"
                                    icon={<Iconify icon="solar:cloud-check-bold" width={16} />}
                                  />
                                </Stack>
                                ...
                                {currentCampaign.videos?.[0]?.video && (
                                  ...
                                  >
                                    ...
                                    >
                                      <source src={getMediaUrl(currentCampaign.videos?.[0]?.video || null)} type="video/mp4" />
                                      <track kind="captions" srcLang="ru" label="Russian" />
                                ...
                                >
                                  <Stack alignItems="center" spacing={1}>
                                    ...
                                    <Typography variant="body2">
                                      Видео будет загружено при сохранении
                                    </Typography>
                              ...
                              <Stack spacing={2}>
                                ...
                                <Stack direction="row" alignItems="center" spacing={2}>
                                  ...
                                  <Box sx={{ flex: 1 }}>
                                    ...
                                    <Typography variant="body2" color="success.dark">
                                      {currentCampaign.images?.length} изображений
                                    </Typography>
                                  </Box>
                                  <Chip
                                    label="Сохранено"
                                  ...
                                  {currentCampaign.images?.map((image, index) => (
                                    ...
                                    >
                                      {image.image ? (
                                        ...
                                        >
                                          <Iconify icon="solar:image-bold" width={32} />
                                        </Box>
                                      )}
                                    </Box>
                                  ))}
                            ...
                            >
                              <Stack spacing={2}>
                                ...
                                <Stack direction="row" alignItems="center" spacing={2}>
                                  ...
                                  <Box sx={{ flex: 1 }}>
                                    <Typography variant="subtitle2" color="info.darker">
                                      Новые изображения загружены
                                    </Typography>
                                    <Typography variant="body2" color="info.dark">
                                      {values.contentFiles?.length} изображений
                                    </Typography>
                                  </Box>
                                  <Button
                                    size="small"
                  ...
                  {values.geoTarget.region && values.geoTarget.district && (
                    ...
                    >
                      ...
                      <Typography variant="body2" color="info.darker">
                        <strong>Целевая локация:</strong> {selectedRegion?.label} → {selectedDistrict?.label}
                      </Typography>
                    </Stack>
                  )}
                      ...
                      <Controller
                        ...
                        render={({ field, fieldState: { error } }) => (
                          <TextField
                            ...
                            select
                            fullWidth
                            label="Время показа на мониторе"
                            error={!!error}
                            helperText={error?.message}
                          >
                      ...
                      <Box sx={{ px: 2, opacity: 0.6 }}>
                        <Stack direction="row" justifyContent="space-between" mb={2}>
                          ...
                          <Typography variant="subtitle2" color="text.secondary">
                            {values.ageRange[0]} - {values.ageRange[1]} {values.ageRange[1] === 65 ? '+' : ''} лет
                          </Typography>
                        </Stack>
                  ...
                  <Card sx={{ p: 2.5 }}>
                    <Stack spacing={2}>
                      <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <Typography variant="subtitle1">Интересы аудитории</Typography>
                      </Stack>
                      ...
                      {values.interests.length > 0 && (
                        ...
                        >
                          <Typography variant="caption" color="primary.darker">
                            <strong>Выбрано:</strong> {values.interests.length} интересов
                          </Typography>
                        </Box>
                      )}
                    </Stack>
                  ...
                  <Card sx={{ p: 2.5 }}>
                    <Stack spacing={2}>
                      <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <Typography variant="subtitle1">Типы площадок</Typography>
                      </Stack>

                      <RHFAutocomplete
                        name="venueTypes"
                        label="Выберите типы площадок"
                        ...
                        {CURRENCIES.map((option) => (
                          <MenuItem key={option.value} value={option.value}>
                            <Stack direction="row" spacing={1}>
                              <Typography>{option.label}</Typography>
                              <Typography color="text.secondary">({option.symbol})</Typography>
                            </Stack>
                          </MenuItem>
                        ))}
                      </TextField>
                    ...
                    <Stack spacing={2}>
                      <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <Typography variant="subtitle2" color="primary.darker">
                          <strong>Прогноз эффективности</strong>
                        </Typography>
                      </Stack>
                      <Grid container spacing={2}>
                        <Grid item xs={4}>
          ...
          render={({ field, fieldState: { error } }) => (
            ...
            >
              <DialogTitle sx={{
                ...
                <Stack direction="row" alignItems="center" spacing={1}>
                  <Iconify icon="solar:calendar-bold-duotone" width={20} />
                  <Typography variant="h6">Расписание показа рекламы</Typography>
                </Stack>
              </DialogTitle>
                  ...
                  {Object.values(field.value).filter(Boolean).length > 0 && (
                    ...
                    >
                      <Typography variant="caption" color="success.darker">
                        <strong>Отлично!</strong> Реклама будет показываться в выбранные временные слоты в течение всего периода кампании.
                      </Typography>
                    </Box>
                  )}
                </Stack>
        ...
        <Card sx={{ p: 3 }}>
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            ...
            <Stack direction="row" spacing={2}>
              ...
              >
                {isEdit ? 'Обновить кампанию' : 'Запустить кампанию'}
              </Button>
            </Stack>
          </Stack>
        </Card>
